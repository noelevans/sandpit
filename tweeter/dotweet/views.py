...
CONSUMER_KEY = 'uL4uSOFSVgZZpyl2Ztn9g' #getattr(settings, 'CONSUMER_KEY', 'YOUR_CONSUMER_KEY')
CONSUMER_SECRET = 'wNUbHKTKeBO6h8A3kg0W6RErT6ctd1KYn40rqrg6Oss' #getattr(settings, 'CONSUMER_SECRET', 'YOUR_CONSUMER_SECRET')
